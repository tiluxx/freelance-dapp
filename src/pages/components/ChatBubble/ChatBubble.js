...
import FileIcon from 'src/pages/components/FileIcon'

function ChatBubble({ content, variant, timestamp, attachment = undefined, sender }) {
    ...
    return (
        <Box maxWidth="80%" minWidth={attachment ? '80%' : 'auto'}>
            <Stack direction="row" justifyContent="space-between" spacing={2} sx={{ mb: 0.25 }}>
                <Typography level="body3">{sender === 'You' ? sender : sender.name}</Typography>
